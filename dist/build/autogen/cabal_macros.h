...
/* package PokerHandHaskell-0.1.0.0 */
#define VERSION_PokerHandHaskell "0.1.0.0"
#define MIN_VERSION_PokerHandHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "PokerHandHaskell-0.1.0.0-1pxTVm3rMUfLJW04VtR38c"

#define CURRENT_PACKAGE_KEY "PokerHandHaskell-0.1.0.0-1pxTVm3rMUfLJW04VtR38c"
